(function() {
  ...
  fournee.controller('EmployeeProfileCtrl', ['$scope', '$log', '$state', '$stateParams', 'ProfileService', 'EmployeeSvc', '$ngConfirm', employeeProfileCtrl]);

  function employeeProfileCtrl($scope, $log, $state, $stateParams, ProfileService, EmployeeSvc, $ngConfirm) {
    $scope.user = {};
